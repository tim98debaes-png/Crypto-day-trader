...
def _htf_available(frame,suffix):
    selected=frame[["time","close","ema20","ema50","ema200","rsi","macd_hist","adx","atr_pct","vol_ratio"]].copy(); selected["available"]=selected["time"].shift(-1); selected=selected.dropna(subset=["available"])
